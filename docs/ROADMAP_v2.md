# Roadmap v2 (arquivado) — elleito.ai

> ⚠️ **Documento arquivado em abril de 2026.**
> Este roadmap descrevia o produto **5 pilares** — substituído pela [Visão v3](../PRODUCT_VISION_v3.md) que reorganiza tudo em 3 módulos (Motor, Cérebro, Operação) e adota um ciclo de **60 dias** em vez de 7 fases longas.
>
> Consulte o roadmap atual em [`ROADMAP.md`](../ROADMAP.md) na raiz. Este arquivo é mantido para histórico.
